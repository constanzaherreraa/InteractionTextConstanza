...
function windowResized() {
  ...
  initializeTextPoints(); // Reinitialize text points with new canvas dimensions
}

function initializeTextPoints() {
  textPoints = []; // Clear existing points
  tposX = width / 2 - tSize * 2.27;
  tposY = height / 2 + tSize / 2;

  textFont(font);

  let points = font.textToPoints("HI THERE!", tposX, tposY, tSize, {
